...
public class SandstoneFurnace extends BlockBase
{
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public static final PropertyBool BURNING = PropertyBool.create("burning");
	
	public SandstoneFurnace(String name) 
	{
	...
	{
		return Item.getItemFromBlock(ModBlocks.SANDSTONE_FURNACE);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(ModBlocks.SANDSTONE_FURNACE);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			playerIn.openGui(Main.instance, Reference.GUI_SANDSTONE_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
